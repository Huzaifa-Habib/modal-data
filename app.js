...
modalDivChild.setAttribute("class", "main-modal")
var p =document.createElement("p");
var pText = document.createTextNode("X")
p.setAttribute("class", "close");
p.setAttribute("onClick", "close()");

modalDiv.appendChild(p)
p.appendChild(pText);
console.log(modalDivChild)

divOfList.appendChild(modalDiv);
...
function details(el) {
    ...
    for (var key in usersList) {
        if (usersList[key].id === el) {
             modalDivChild.innerText = ("Name: " + usersList[key].name + '\n' + "User Name: " + usersList[key].username + '\n' +
             "Email: " +usersList[key].email + '\n' + "Street " + (usersList[key].address.street)  + '\n' + "Suite: " + (usersList[key].address.suite)
             + '\n' + "City: " + (usersList[key].address.city)+ '\n' + "Zip: " + usersList[key].address.zipcode 
             + '\n' + "Company Name: " + (usersList[key].company.name)+ '\n' + "Catch Phrase: " + (usersList[key].company.catchPhrase)
             + '\n' + "BS: " + (usersList[key].company.bs)
            ...
            for (var key in usersList) {
                ...
                if (typeof (usersList[key].address) === "object") {
                    console.log((usersList[key].address))
                    // modalDivChild.innerHTML ="Address " + (usersList[key].address.street);
                }
                if (typeof (usersList[key].company) === "object") {
                    console.log((usersList[key].company))
                } 
...
// console.group(divOfList);

function close() {
    modalDiv.style.display = "none"
    alert("asda")
}
console.log(divOfList)
